...
public class WxApiController {
     ...
     * 获取扫码人的信息，添加数据
     * @param code 由微信返回，
     * @param state 由微信返回，但是是在生成二维码的步骤中，由服务端提供
     * @param session
     * @return
     * @throws Exception
     */
...
/*            //得到授权临时票据code
    ...
    public String getWxCode() throws UnsupportedEncodingException {
        ...
        /*
        * 此处参考github上的代码
        *  CSRF_KEY就是配置文件中的csrfKey: WeChat_WxJava_Demo
        * */
...
//        Boolean isNotCsrf = MD5Utils.verify(CSRF_KEY + date, state);
        ...
        String url = String.format(
                baseUrl,
                ConstantWxUtils.WX_OPEN_APP_ID, //wx.open.app_id=wxed9954c01bb89b47
                redirect_url,
                "xunqi"
        );
/*
结果如下
 https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxed9954c01bb89b47&redirect_uri="http%3A%2F%2Fguli.shop%2Fapi%2Fucenter%2Fwx%2Fcallback"&response_type=code&scope=snsapi_userinfo&state=xunqi#wechat_redirect
 */
        //重定向到请求微信地址
        return "redirect:" + url;
    }
